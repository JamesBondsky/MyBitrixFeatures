...
<section class="top-filter">
    ...
    <div class="view-type">
        <a class="view-type__button--block view-type__button--selected">
            <i class="visually-hidden" title="плиткой">плиткой</i>
        </a>
        <a class="view-type__button--list">
            <i class="visually-hidden" title="списком">списком</i>
        </a>
    </div>
</section>
<?
